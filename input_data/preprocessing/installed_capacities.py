import pandas as pd
from input_data.preprocessing.utilities import Configuration, to_latex
...
def preprocess_pv_wind_per_nuts(c, cap_national):
    ...
    potential_re_nodes.to_csv('C:/Users/6574114/Documents/Research/EHUB-Py_Productive/input_data/clean_data/max_re_cap/max_re_nodes.csv')
