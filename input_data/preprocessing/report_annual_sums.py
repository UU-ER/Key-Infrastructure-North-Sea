import pandas as pd
from input_data.preprocessing.utilities import to_latex

climate_year = 2009

hydro_inflows = pd.read_csv('./input_data/clean_data/hydro_inflows/hydro_inflows.csv', header=[0,1], index_col=0)
production = pd.read_csv('./input_data/clean_data/production_profiles_re/production_profiles_re.csv', header=[0,1], index_col=0)
demand = pd.read_csv('./input_data/clean_data/demand/TotalDemand_NT_'+ str(climate_year)+ '.csv', header=[0], index_col=0)
capacities = pd.read_csv('./input_data/clean_data/installed_capacities/capacities_node.csv', header=[0], index_col=0)
...
summary_table_node.to_csv('./input_data/reporting/demand_supply_node.csv')
...
#          './input_data/reporting/02_DemandSupply_node.tex',
#          rounding=2)
...
summary_table_country.to_csv('./input_data/reporting/demand_supply_country.csv')
to_latex(summary_table_country.T,
         ...
         './input_data/reporting/02_DemandSupply_country.tex',
         rounding=2)
